    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview"><a href="/admin/users"><i class="glyphicon glyphicon-user"></i>
                        <span>User</span></a>
                </li>
                <li class="treeview"><a href=""><i class="glyphicon glyphicon-glass"></i> <span>Food</span></a>
                </li>
...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <button type="button" class="btn btn-block btn-primary btn-lg">Add Food</button>
            </ol>
        </section>
                    ...
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td><?php echo $food->price ?> ,000 VND</td>
